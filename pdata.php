...
<h5><b>Comentario:  <?php echo $c['Comentario'].= ($c['timesloat']=="") ? "" : " [ CUPON: #" .$c['timesloat'] . " ]";?></b></h5>
...
$Descuento = str_replace($String, "", $c['p_method']);
...
<ul class="list-group">
  ...
  <li class="list-group-item" >
    ...
    <span class="badge bg-primary float-right budge-own" ><?php echo $c['p_method'];?></span> Descuento 
    <span class="badge bg-primary float-center budge-own" ><?php echo  ($c['timesloat']!=' ') ? $c['porcent_cupon'] : "" ; ;?></span>
  </li>
   <li class="list-group-item">
   ...
   <li class="list-group-item">
    <span class="badge bg-info float-right budge-own" ><?php echo number_format(($c['total']-$Descuento),2,'.',',');?></span> Total
  </li>
  <li class="list-group-item">
