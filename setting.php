		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form">Actualizar Ajuste</h4>
							...
							<div class="form-body row">
                              ...
                              <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
								<div class="form-group">
									<label for="cname">Cliente Onesignal Id</label>
									<input type="text" id="cname" class="form-control"  name="oid" value="<?php echo $getkey['one_key'];?>"  >
								</div>
								</div>
								 <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                <div class="form-group">
									<label for="cname">Cliente Onesignal Hash</label>
									<input type="text" id="cname" class="form-control"  name="ohash" value="<?php echo $getkey['one_hash'];?>"  >
								</div>
								</div>
								 <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
								<div class="form-group">
									<label for="cname">Motos Onesignal Id</label>
									<input type="text" id="cname" class="form-control"  name="rid" value="<?php echo $getkey['r_key'];?>"  >
								</div>
								</div>
								 <div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                <div class="form-group">
									<label for="cname">Motos Onesignal Hash</label>
								...
								?>
								<div class="form-group">
									<label for="cname">Zona Horaria</label>
								...
								<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
								<div class="form-group">
									<label for="cname">Valor orden minima</label>
								...
								<div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
								<div class="form-group">
									<label for="cname">Impuesto %</label>
								...
								<div class="form-group">
									<label for="cname">Website Titulo</label>
								...
								<div class="form-group">
									<label for="cname">Politica de privacidad</label>
								...
								<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
								<div class="form-group">
									<label for="cname">Acerca de nosotros</label>
								...
								<div class="form-group">
									...
									<label for="cname">Contactenos</label>
								...
								<div class="form-group">
									...
									<label for="cname">Terminos & Condiciones</label>
