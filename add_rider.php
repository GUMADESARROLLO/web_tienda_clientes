		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form">Agregar Motorizado</h4>
					...
					<div class="px-3">
						<form class="form" method="post" enctype="multipart/form-data">
							<div class="form-body">
								...
								<div class="form-group">
									<label for="cname">Telefono(Solo Digito)</label>
									<input type="text" id="dcharge"  maxlength="10" class="form-control" pattern="[0-9]+"  placeholder="Numero de telefono" name="dcharge" required >
								</div>
 	...
 	<div class="form-group">
							...
							<div class="form-actions">
								...
								<button type="submit" name="sub_cat" class="btn btn-raised btn-raised btn-primary">
									<i class="fa fa-motorcycle"></i> Guardar
								</button>
							</div>
